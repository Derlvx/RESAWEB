            ...
            <tr>
              <td align="center" style="padding:0;Margin:0">
                <table bgcolor="#ffffff" class="es-header-body" align="center" cellpadding="0" cellspacing="0"
                  ...
                  <tr>
                    <td class="esdev-adapt-off" align="left" bgcolor="#333333"
                              ...
                              <tr>
                                <td align="left" style="padding:0;Margin:0;font-size:0px"><a target="_blank"
                                    ...
                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#926B4A;font-size:14px"><img
                                      ...
                                      width="120" title="Logo" height="23"></a></td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                              ...
                              <tr>
                                <td align="center" style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px">
                                  <p
                                    ...
                                    Your feedback will help us to improve our products and services and ensure that we
                                    are meeting the needs of our customers.</p>
                                </td>
                              </tr>
                            </table>
                          </td>
                              ...
                              <tr>
                                <td align="center"
                                  ...
                                  <table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                      <td
                                        style="padding:0;Margin:0;border-bottom:1px solid #333333;background:none;height:1px;width:100%;margin:0px">
                                      </td>
                                    </tr>
                                  </table>
                                </td>
                                  ...
                                  <table cellpadding="0" cellspacing="0" class="es-table-not-adapt es-social"
                                    ...
                                    <tr>
                                      <td align="center" valign="top" style="padding:0;Margin:0;padding-right:20px"><a
                                          ...
                                          style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#926B4A;font-size:14px"><img
                                            title="Facebook"
                                            src="https://gdchug.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png"
                                      ...
                                      <td align="center" valign="top" style="padding:0;Margin:0;padding-right:20px"><a
                                          ...
                                          style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#926B4A;font-size:14px"><img
                                            title="Twitter"
                                            src="https://gdchug.stripocdn.email/content/assets/img/social-icons/logo-black/twitter-logo-black.png"
                                      ...
                                      <td align="center" valign="top" style="padding:0;Margin:0;padding-right:20px"><a
                                          ...
                                          style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#926B4A;font-size:14px"><img
                                            title="Instagram"
                                            src="https://gdchug.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png"
                                      ...
                                      <td align="center" valign="top" style="padding:0;Margin:0"><a target="_blank"
                                          ...
                                          style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#926B4A;font-size:14px"><img
                                            title="Youtube"
                                            src="https://gdchug.stripocdn.email/content/assets/img/social-icons/logo-black/youtube-logo-black.png"
                                ...
                                <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px">
                                  <p
                                    ...
                                    junk folders).<br><a target="_blank"
                                      ...
                                      style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#333333;font-size:12px"
                                      href="https://www.youtube.com/watch?v=dQw4w9WgXcQ&ab_channel=RickAstley">Unsubscribe</a>
                                  </p>
                                </td>
                              </tr>
                            </table>
